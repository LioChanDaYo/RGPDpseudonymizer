...
KNOWN_AMBIGUOUS = {
    "Dominique", "Claude", "Camille", "Lou", "Eden", "Morgan",
    "Sacha", "Alix", "Noa", "Andrea", "Maxime", "Charlie",
    "Ange", "Céleste", "Stéphane",
}
...
EXTRA_MALE = {
    "Alain", "René", "Yves", "Guy", "Gilbert", "Roland", "Gaston",
    "Raymond", "Roger", "Fernand", "Auguste", "Eugène", "Alfred",
    "Armand", "Patrice", "Pierrick", "Yoann", "Gaspard", "Titouan",
    "Médéric", "Loup", "Esteban", "Kamil", "Amine", "Bilal",
    "Reda", "Naël", "Moussa", "Karim", "Rachid", "Omar", "Farid",
    "Ali", "Saïd", "Malik", "Issa", "Adama", "Boubacar", "Mamadou",
    "Cheikh", "Ousmane", "Souleymane", "Amadou", "Abdoulaye", "Seydou",
    "Lamine", "Oumar", "Thierno", "Demba", "Modou", "Ryad", "Sofian",
    "Samir", "Farouk", "Riad", "Zakaria", "Hamza", "Walid", "Tarik",
    "Kamel", "Ismaël", "Kévin", "Jérémy", "Mickaël", "Grégory",
    "Bryan", "Kevin", "Steven", "Jeremy", "Didier", "Lionel",
    "Francis", "Étienne", "Édouard", "Loïs", "Élie", "Anaël",
    "Arnaud",
}

EXTRA_FEMALE = {
    "Nathalie", "Sylvie", "Françoise", "Monique", "Martine", "Christine",
    "Jacqueline", "Annie", "Valérie", "Sandrine", "Stéphanie",
    "Laura", "Pauline", "Émilie", "Lisa", "Océane", "Elsa",
    "Lena", "Mélanie", "Noémie", "Justine", "Alexandra", "Laure",
    "Audrey", "Aurélie", "Céline", "Virginie", "Élodie", "Karine",
    "Carole", "Corinne", "Pascale", "Nadine", "Chantal",
    "Éliane", "Henriette", "Raymonde", "Lucienne", "Thérèse",
    "Bernadette", "Cécile", "Christiane", "Solange", "Renée",
    "Huguette", "Pierrette", "Valentine", "Clémence", "Capucine",
    "Apolline", "Adèle", "Éléonore", "Élisa",
    "Léonie", "Blanche", "Céleste", "Constance",
    "Héloïse", "Cassandre", "Fanny", "Delphine", "Marion", "Estelle",
    "Leslie", "Mélissa", "Jessica", "Jennifer", "Cindy", "Kelly", "Wendy",
    "Magalie", "Émeline", "Coralie", "Angélique", "Amandine",
    "Séverine", "Érika", "Laurène", "Maéva", "Tiphaine", "Clotilde",
    "Solène", "Lucile",
    "Léna", "Salomé", "Théa", "Éléa", "Alicia", "Maëlys",
    "Louane", "Ninon", "Albane", "Giulia", "Violette", "Lison",
    "Flavie", "Louna", "Alba", "Soline",
    "Mahaut", "Perrine", "Hortense", "Aliénor", "Augustine", "Honorine",
    "Awa", "Fatou", "Aïssata", "Fatoumata", "Mariama", "Khady",
    "Aïda", "Rama", "Coumba", "Ndeye", "Astou", "Bineta", "Oumou",
    "Samira", "Karima", "Rachida", "Malika",
    "Houria", "Fatima", "Khadija", "Aïcha", "Hafsa", "Imane",
    "Salma", "Rania", "Lilia", "Soumaya", "Amira",
    "Danielle", "Josiane", "Denise", "Colette", "Nicole",
    "Yvonne", "Madeleine", "Marcelle", "Marguerite",
    "Germaine", "Geneviève", "Andrée", "Paulette", "Yvette", "Ginette",
    "Hélène", "Brigitte", "Michèle", "Florence", "Éva", "Victoire",
    "Amélie", "Morgane", "Maëlle",
    "Sabrina", "Gaëlle", "Aurore", "Anaëlle",
    "Diane", "Rachel", "Rebecca", "Garance",
    "Sylvaine",
    "Véronique",
    "Suzanne", "Simone",
    "Élise", "Célia",
    ...
    "Odette",
    "Mariam", "Aminata",
    "Yasmine", "Leïla", "Nadia", "Soraya",
    "Aya",
    "Romane", "Gabrielle", "Victoria",
    "Marine", "Anaïs",
    "Mathilde",
    "Isabelle",
}
