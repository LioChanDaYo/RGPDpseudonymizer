...
with open_database(db_path, passphrase) as db_session:
    ...
    for dup_pseudo, count in duplicates:
        ...
        for e in entities:
            ...
            print(f"    Pseudonym full (combined): \"{e[4]} {e[5]}\" if e[4] and e[5] else e[4] or e[5]")
            print(f"    Are pseudonym_first and pseudonym_last identical? {e[4] == e[5]}")
            print()
