...
- [x] **Task 5.7.8: Create and push git tag v1.1.0** (AC: 7)
  ...
  - [ ] Verify package appears on PyPI: `https://pypi.org/project/gdpr-pseudonymizer/1.1.0/`
...
- PyPI verification: pending release.yaml workflow completion (PYPI_TOKEN secret required)
