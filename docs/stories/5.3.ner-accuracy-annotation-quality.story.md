...
- [ ] **Task 5.3.11: Full regression suite** (AC: 5)
  ...
  - [ ] Verify test count ≥ 1179 baseline (Story 5.2 count)
  - [ ] Verify existing `process`, `batch`, `destroy-table`, `delete-mapping`, `list-entities` commands unaffected
